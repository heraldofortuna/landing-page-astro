<template>
  <div class="bg-transparent h-14 md:h-16 inline-flex rounded-full border border-neutral-200">
    <button
      ...
      :class="{
        'bg-white text-black': selectedValue === option.value,
        'text-white hover:text-gray-dark': selectedValue !== option.value,
